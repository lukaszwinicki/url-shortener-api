 ...
 */
final class Version20260217202005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE urls (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, short_code VARCHAR(8) NOT NULL, original_url TEXT NOT NULL, visibility VARCHAR(255) NOT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, click_count INT NOT NULL, session_id INT NOT NULL, PRIMARY KEY (id))');
